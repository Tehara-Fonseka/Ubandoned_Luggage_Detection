...
class Tracker:
    ...
    def __init__(
        ...
        # self.id = str(uuid.uuid4()) #TT
        Tracker.id_count += 1 #TT
        self.id = str(Tracker.id_count) #TT
        self.status = 'unconfirmed'
        self.model_spec = model_spec

        self.steps_alive = 1
        self.steps_positive = 1
        self.staleness = 0.0    # The quality of being no longer new or fresh, usually as a result of being kept for too long
    ...
    def update(self, detection: Detection):
        ...
        if detection.label is not None:
            self.update_label(detection.label)  #TT
...
class MultiObjectTracker:
    ...
    def active_tracks(self,
        ...
        for tracker in self.trackers:
            ...
            cond4 = tracker.maturity >= 1 #TT
            if cond1 and cond2 and cond3 and cond4:
                tracks.append(Track(id=tracker.id, box=tracker.box, label=tracker.label, maturity=tracker.maturity)) #TT
